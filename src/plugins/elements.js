...
/* ReferenceError: msgbox is not defined */
...
// Vue.component(Scrollbar.name, Scrollbar)   // el-scrollbar
Vue.use(Scrollbar);  // 注册单独引入的隐藏组件
Vue.use(Drawer); // Vue.component(Drawer.name, Drawer)
Vue.use(Popconfirm);
Vue.use(Pagination);
Vue.use(Dialog);
Vue.use(Dropdown);
...
Vue.use(TimeSelect);
Vue.use(TimePicker);
Vue.use(Popover);   // Vue.Component(Popover.name, Popover)
Vue.use(Tooltip);
Vue.use(Tabs);
Vue.use(TabPane);
Vue.use(Alert);
