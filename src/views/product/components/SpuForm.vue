<template>
  <el-form label-width="100px" v-show="visible">
    ...
    <el-form-item label="销售属性">
      ...
      <el-table border style="margin-top: 20px" :data="spuInfo.spuSaleAttrList" row-key="id">
        ...
        <el-table-column label="属性值名称列表">
          <template slot-scope="{row, $index}">
            ...
            <el-input
              ...
              size="small"
              placeholder="名称"
              @keydown.enter.native="addSpuSaleAttrValue(row, $index)"
    ...
    async save () {
      ...
      */
      ...
      try {
        ...
        // 如果成功了
        this.$message.success(result.message || '保存SPU成功')
        // 显示列表界面
